...
const props = defineProps({
    lockerCodigo: { type: String, default: 'B-142' }
});
...
const enviarSolicitud = () => {
    ...
    router.post('/devolucion-locker/enviar', {
        codigo: props.lockerCodigo
    });
};
</script>
    ...
    <main class="flex flex-col items-center min-h-screen py-10 px-6 bg-white">
        ...
        <section class="w-full max-w-md flex flex-col items-center">
            ...
            <div class="w-full bg-[#F3F4F6] rounded-2xl p-8 flex flex-col items-center gap-4 shadow-sm border border-gray-100 mb-10">
                ...
                <div class="bg-white p-4 rounded-full shadow-sm mb-2" aria-hidden="true">
                ...
                <div class="text-center">
                    ...
                    <a 
                        ...
                        aria-label="Descargar PDF del reglamento de lockers"
                    >
            ...
            <div class="flex items-start gap-3 mb-12 w-full px-2">
                ...
                <label for="confirm-baja" class="text-gray-700 text-sm leading-tight cursor-pointer select-none">
                    He leído el reglamento y confirmo que deseo devolver el locker <span class="font-bold text-black">{{ props.lockerCodigo }}</span>.
                </label>
            </div>
            ...
            <div class="w-full">
                <button 
                    ...
                    aria-label="Enviar solicitud de devolución"
                >
                    Enviar
                </button>
            </div>
